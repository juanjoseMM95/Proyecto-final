...
import com.arka.arkajjmunozm.application.usecase.CotizacionApplicationService;
...
public class CotizacionController {
    ...
    private final IProductService productUseCase;

    public CotizacionController(CotizacionApplicationService cotizacionService, IProductService productUseCase) {
