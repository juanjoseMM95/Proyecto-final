package com.arka.arkajjmunozm.infraestructure.adapter.out.microservice;
...
public class CotizadorServiceAdapter implements CotizadorServicePort {
    ...
    public CotizadorServiceAdapter(RestTemplate restTemplate, @Value("${microservices.cotizador.url}") String cotizadorBaseUrl) {
